...
fotografije_varijabla.paste(red_vert,(red_resize_vertical,fotografije_varijabla.size[1] - red_resize_horizontal))
...
fotografije_varijabla.paste(yellow_vert,(yellow_resize_vertical,fotografije_varijabla.size[1] - yellow_resize_horizontal))
...
fotografije_varijabla.paste(blue_vert,(blue_resize_vertical,fotografije_varijabla.size[1] - blue_resize_horizontal))
